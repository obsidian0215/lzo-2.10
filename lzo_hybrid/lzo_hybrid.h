/* lzo_hybrid.h - GPU-specific header providing limited LZO types/compat macros
 * This header is a GPU-friendly equivalent to minilzo.h and is intended
 * for use inside OpenCL kernels.*/
#ifndef __LZO_GPU_H_INCLUDED
#define __LZO_GPU_H_INCLUDED 1
