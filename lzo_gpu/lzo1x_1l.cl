...
/* LZO1X-1L: 中等版本，使用12位字典 (D_BITS = 12) */
...
static lzo_uint
lzo1x_1l_compress_core(LZO_ADDR_GLOBAL const lzo_bytep in , lzo_uint  in_len,
    ...
    lzo_uint  ti, lzo_voidp wrkmem)
{
    ...
    while (l > 20)
    {
        ...
        dict_clear(wrkmem);
        t = lzo1x_1l_compress_core(ip, ll, op, out_len, t, wrkmem);
        ip += ll;
        op += *out_len;
        l -= ll;
    }
